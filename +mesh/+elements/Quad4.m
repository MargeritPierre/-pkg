classdef Quad4 < pkg.mesh.elements.AbstractElement
...
%% CONSTRUCTOR / DESTRUCTOR
    methods
        ...
        % Constructor
            ...
            this.Faces = pkg.mesh.elements.ElementTable('Types',this,'NodeIdx',1:4) ;
            this.Edges = pkg.mesh.elements.ElementTable('Types',pkg.mesh.elements.LagrangeElement('1D',1),'NodeIdx',[1 2 ; 2 3 ; 3 4 ; 4 1]) ;
        end
