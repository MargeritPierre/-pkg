classdef Quadrangle < pkg.geometry.mesh.elements.base.BaseElement
...
% INTEGRATION QUADRATURE
    properties
        ...
        GaussIntegrationPoints = 0.5*[1 1]+0.5*[-1 -1 ; 1 -1 ; 1 1 ; -1 1]/sqrt(3) % [nGaussIntPts nDims]
...
%% CONSTRUCTOR / DESTRUCTOR
    methods
        ...
        % Constructor
            this.Edges = pkg.geometry.mesh.elements.ElementTable('Types',pkg.geometry.mesh.elements.base.Bar,'Indices',[1 1 2 ; 1 2 3 ; 1 3 4 ; 1 4 1]) ;
            this.Faces = pkg.geometry.mesh.elements.ElementTable('Types',this,'Indices',[1 1 2 3 4]) ;
        end
    ...
    methods
        ...
        % Exactly three nodes ON the levelset: add a triangle
            ...
            if any(bool)
                ...
                elems = [elems ; ...
                            pkg.geometry.mesh.elements.ElementTable(...
                                        'Types',pkg.geometry.mesh.elements.base.Triangle ...
