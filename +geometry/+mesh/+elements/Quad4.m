classdef Quad4 < pkg.geometry.mesh.elements.AbstractElement
%QUAD4 element following the ABAQUS numerotation
...
%% CONSTRUCTOR / DESTRUCTOR
    methods
        function this = Quad4(varargin)
        % Constructor
            this = this@pkg.geometry.mesh.elements.AbstractElement(varargin{:}) ;
            this.Faces = pkg.geometry.mesh.elements.ElementTable('Types',this,'NodeIdx',1:4) ;
            this.Edges = pkg.geometry.mesh.elements.ElementTable('Types',pkg.geometry.mesh.elements.LagrangeElement('1D',1),'NodeIdx',[1 2 ; 2 3 ; 3 4 ; 4 1]) ;
        end
