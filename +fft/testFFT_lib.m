...
TORS = pkg.fft.Field(grid,'Size',[3 2]) ;
...
% Any other function
kappa = pkg.fft.Field(grid).setdata(@rand) ;
mu = pkg.fft.Field(grid).setdata(@rand) ;
